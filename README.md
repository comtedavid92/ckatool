...
trunk_rom = numpy.max(neck.trunk_angle) - numpy.min(neck.trunk_angle)
shoulder_rom = numpy.max(shoulder.angle) - numpy.min(shoulder.angle)
elbow_rom = numpy.max(elbow.angle) - numpy.min(elbow.angle)
